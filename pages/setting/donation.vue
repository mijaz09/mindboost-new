                ...
                <div id="basic-plan" class="card mb-5 mb-lg-0" data-plan="starter">
                  <div class="card-body">
                    ...
                    <h6 class="card-price text-center">
                      <span class="price" data-price-type="starter">8.00</span><span
                        class="period"
                      >/month</span>
                    </h6>
                    ...
                    <div class="d-grid">
                      ...
                      <span v-else>
                        <div class="row">
                          <button class="btn btn-warning text-uppercase buy-now" :disabled="currentSubscription() === 1">Buy Now</button>
                        </div>
                      </span>
                    </div>
                  </div>
              ...
              <div class="col-md-4">
                <div id="team-plan" class="card mb-5 mb-lg-0" data-plan="pro">
                  <div class="card-body">
                    ...
                    <h6 class="card-price text-center">
                      <span class="price" data-price-type="pro">5</span><span
                        class="period"
                      >/month</span>
                    </h6>
                    ...
                    <div class="d-grid">
                      ...
                      <span v-else>
                        <div class="row">
                          <button class="btn btn-warning text-uppercase team-plan" :disabled="currentSubscription() === 2">Buy Now</button>
                        </div>
                      </span>
                    </div>
                  </div>
                    ...
                    <ul class="fa-ul">
                      ...
                      <li>
                        <div class="pricing-toggle my-2 d-flex align-items-center">
                          ...
                          <div>
                            <input id="enterprise-year" type="radio" class="me-1" name="cycle-enterprise" value="year">
...
export default {
   ...
   */
    async submitForm () {
      try {
        await axios.post('http://localhost:8000/api/enterprise-plan-contact', this.contact_form)
    ...
    async GetManagerDetails () {
      ...
      if (userStore.user.inviter_id) {
        const response = await axios.post('http://localhost:8000/api/fetch-manger-detail', { manager_id: userStore.user.inviter_id })
